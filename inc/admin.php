				...
				<div class="inner-sidebar">
					<div class="postbox">
						...
						<div class="inside">
							...
							<p>
								<a href="http://www.datafeedr.com/ads-by-datafeedr" target="_blank" title="Learn more about datafeedr.com" id="datafeedr-avatar">
									<img src="<?php echo DFADS_PLUGIN_URL; ?>img/eric.jpg" alt="Eric @ datafeedr.com" width="50" height="50" />
								</a>
								Hi, <?php echo $name; ?>!
							</p>
							<p>Thanks for using the <em>Ads</em> plugin! We'd love to hear what you think.</p>
							<p>Eric Busch<br /><a href="http://www.datafeedr.com/ads-by-datafeedr" target="_blank" title="Learn more about datafeedr.com" class="datafeedr-link">datafeedr.com</a></p>
						</div>
					</div>
